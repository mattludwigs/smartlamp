defmodule SmartLampFw.MixProject do
  use Mix.Project
  ...
  defp deps do
    [
      ...
      {:smart_lamp, path: "../smart_lamp", targets: @all_targets},
      {:smart_lamp_ui, path: "../smart_lamp_ui", targets: @all_targets, env: Mix.env()},
